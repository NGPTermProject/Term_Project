...
void InitGameObject()
{
    ...
    m_monster.push_back(Monster(MONSTER::PLANT, 624, 728, 500));
    m_monster.push_back(Monster(MONSTER::PLANT, 816, 280, 500));
    m_monster.push_back(Monster(MONSTER::PLANT, 1080, 696, 500));
    m_monster.push_back(Monster(MONSTER::PLANT, 1200, 696, 500));
